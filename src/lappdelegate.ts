...
export class LAppDelegate {
	...
	public initialize(): boolean {
		...
		canvas = live2d_config._canvas_elem;
		canvas.width = live2d_config._canvas_width;
		canvas.height = live2d_config._canvas_height;
		...
		if (supportTouch) {
			// タッチ関連コールバック関数登録
			document.addEventListener("touchstart", onTouchBegan, false);
			document.addEventListener("touchmove", onTouchMoved, false);
			document.addEventListener("touchend", onTouchEnded, false);
